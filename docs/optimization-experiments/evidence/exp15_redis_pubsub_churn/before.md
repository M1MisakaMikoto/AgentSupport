# Experiment `exp15_redis_pubsub_churn` — phase `before`

- timestamp: `2026-08-25T06:00:57+00:00`
- git head: `307c773`
- python: `3.12.6`
- database: `postgresql+psycopg://agent:agent@localhost:5432/agentsupport_exp`
- command: `python devtools/experiments/exp15_redis_pubsub_churn.py --phase before`
...
| --- | --- |
| wait() calls | 30 |
| pubsub objects created | 31 |
| SUBSCRIBE commands issued | 31 |
| publish wakes a waiter (functional) | False |
