# Experiment `exp9_event_loop_blocking` — phase `before`

- timestamp: `2026-08-25T05:37:39+00:00`
- git head: `307c773`
- python: `3.12.6`
- database: `postgresql+psycopg://agent:agent@localhost:5432/agentsupport_exp`
- command: `python devtools/experiments/exp9_event_loop_blocking.py --phase before`
...
| stream first-poll duration (sync query) | 4336 ms |
| timer scheduled for +100ms actually fired at | 4336 ms |
| event-loop stall (timer overrun) | 4236 ms |
