...
async def create_workspace(
    ...
    return platform_service(request).create_workspace(body.name, idempotency_key)
...
async def create_session(
    ...
    return platform_service(request).create_session(body.workspace_id, idempotency_key)
...
async def create_conversation(
    ...
    return await platform_service(request).create_conversation(
