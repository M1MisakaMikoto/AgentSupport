...
async def submit_input(
    ...
    return await agentsupport_service(request).submit_input(
        conversation_id,
        body.interaction_id,
        body.value,
        body.expected_seq,
...
async def submit_approval(
    ...
    return await agentsupport_service(request).submit_approval(
        conversation_id,
        body.approval_id,
        body.decision,
        body.expected_seq,
...
async def cancel(
    ...
    return await agentsupport_service(request).cancel(
        conversation_id,
