...
def _stub_context() -> ExecutionContext:
    repository = SimpleNamespace(
        ...
        list_conversations=lambda session_id=None: [],
        list_session_events=lambda session_id: [],
    )
...
def _build(file_ref_format: bool) -> dict:
    ...
    return _build_run_request(
        request, conversation, session, workspace, _stub_context()
    )
