...
from agent_platform.dev_console import (
    AcceptanceRequest,
    CommandResult,
...
async def test_dev_console_status_normalizes_compose_json(monkeypatch):
    ...
    monkeypatch.setattr("agent_platform.dev_console.httpx.AsyncClient", lambda **kwargs: UnavailableClient())
...
def test_windows_launcher_starts_loopback_console_without_starting_stack():
    ...
    assert "agent_platform.dev_console" in powershell
