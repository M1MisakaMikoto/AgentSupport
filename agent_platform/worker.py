...
from .coordination import JobClaim, JobState, RunCommand, RunnerEndpoint
from .core_runtime import TraeCoreRunnerRuntime
from .domain import TERMINAL_STATES, Checkpoint, ExecutionState
from .events import EventEnvelope
from .kubernetes_runtime import KubernetesRuntimeDriver
from .ports import CoreRuntime, RuntimeDriver
from .repository import PostgresRepository, RepositoryConflict, StaleClaim
...
def _runtime_driver(config: Settings) -> RuntimeDriver:
...
def _core_runtime(config: Settings) -> CoreRuntime | None:
...
class DistributedWorker:
    ...
    def __init__(
        ...
        *,
        ...
        self.core_runtime = core_runtime if core_runtime is not None else _core_runtime(config)
        self.skill_provider = skill_provider or LocalSkillProvider(config.skills_root)
        self.enabled_skills = [
